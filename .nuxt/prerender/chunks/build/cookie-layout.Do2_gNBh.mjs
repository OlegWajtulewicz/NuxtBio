globalThis.__timing__.logStart('Load chunks/build/cookie-layout.Do2_gNBh');import { watch, nextTick, mergeProps, useSSRContext } from 'file://C:/Users/vaj-o/OneDrive/Desktop/NuxtBio/node_modules/vue/index.mjs';
...
import { _ as _sfc_main$1, a as _sfc_main$4, M as MenuMobile, C as Cookies } from './ThePreloader.DpW52_Sz.mjs';
import { F as FooterMain } from './FooterMain.LkGQDAhI.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "wrapper cookie" }, _attrs))}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/cookie-layout.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/cookie-layout.Do2_gNBh');
//# sourceMappingURL=cookie-layout.Do2_gNBh.mjs.map
