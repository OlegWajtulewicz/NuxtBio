...
import { createError as createError$1, sanitizeStatusCode, appendHeader, getRequestHeader, getRequestHeaders, setCookie, getCookie, deleteCookie } from 'file://C:/Users/vaj-o/OneDrive/Desktop/NuxtBio/node_modules/h3/dist/index.mjs';
...
import { _api, disableCache, addAPIProvider, setCustomIconsLoader } from 'file://C:/Users/vaj-o/OneDrive/Desktop/NuxtBio/node_modules/@iconify/vue/dist/iconify.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file://C:/Users/vaj-o/OneDrive/Desktop/NuxtBio/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./about.BFs0ioQr.mjs')
  },
  {
    name: "cookie",
    path: "/cookie",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./cookie.3NUiKICB.mjs')
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./index.CtlmK4lZ.mjs')
  },
  {
    name: "privacy",
    path: "/privacy",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./privacy.CjNdMFR8.mjs')
  },
  {
    name: "work-slug",
    path: "/work/:slug()",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./_slug_.CyY1a-ZJ.mjs')
  },
  {
    name: "work",
    path: "/work",
    meta: __nuxt_page_meta || {},
    component: () => import('./index.DHT-yA0X.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index.KwqmrH90.mjs').then((r) => r["default"] || r.default || r));
...
function getDomainFromLocale(localeCode) {
  ...
  const domain = ((_b = (_a2 = config2 == null ? void 0 : config2.domainLocales) == null ? void 0 : _a2[localeCode]) == null ? void 0 : _b.domain) || (lang == null ? void 0 : lang.domain) || ((_c = lang == null ? void 0 : lang.domains) == null ? void 0 : _c.find((v) => v === host));
  if (domain) {
...
const layouts = {
  "about-layout": defineAsyncComponent(() => import('./about-layout.098ybN3k.mjs').then((m) => m.default || m)),
  "cookie-layout": defineAsyncComponent(() => import('./cookie-layout.BkrRJ42x.mjs').then((m) => m.default || m)),
  "home-layout": defineAsyncComponent(() => import('./home-layout.CUH_eiJB.mjs').then((m) => m.default || m)),
  "privacy-layout": defineAsyncComponent(() => import('./privacy-layout.D3bDZMRK.mjs').then((m) => m.default || m)),
  "slug-layout": defineAsyncComponent(() => import('./slug-layout.B1sV-dXD.mjs').then((m) => m.default || m)),
  "work-layout": defineAsyncComponent(() => import('./work-layout.DAp3NYwx.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.CpYejuTN.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500.Cz9La0UF.mjs'));
...
export { _export_sfc as _, useRouter as a, navigateTo as b, useNuxtApp as c, useRuntimeConfig as d, entry$1 as default, withoutTrailingSlash as e, useI18n as f, general as g, hasProtocol as h, useRequestEvent as i, joinURL as j, withLeadingSlash as k, parseURL as l, encodePath as m, nuxtLinkDefaults as n, encodeParam as o, parseQuery as p, useRoute as q, resolveRouteObject$1 as r, asyncDataDefaults as s, createError as t, useHead as u, useAppConfig as v, withTrailingSlash as w };
